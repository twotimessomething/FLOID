...
export function InfoSidebar() {
  const { isInfoSidebarOpen, toggleInfoSidebar, infoSidebarWidth, setInfoSidebarWidth, openSettingsModal } = useUIStore();
  ...
  return (
    ...
    >
      ...
      {/* Settings button */}
      <div className="flex-shrink-0 p-3 border-t border-[var(--color-border)] flex justify-end">
        <button
