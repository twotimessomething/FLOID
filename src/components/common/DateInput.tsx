  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <input
        ...
        disabled={disabled}
        className="px-2 py-1.5 text-sm bg-[var(--color-input-bg)] text-[var(--color-text-primary)] border border-[var(--color-border)] rounded-[var(--radius-sm)] transition-colors duration-150 focus:outline-none focus:border-[var(--color-focus)] disabled:bg-[var(--color-background)] disabled:text-[var(--color-text-muted)]"
      />
    </div>
  );
}
